...
specification is in docs/BUILD-SPEC.md. Read it fully at the start of every
...
## Commands
- Full pipeline: make all  (or python -m src.run_all if make is unavailable)
- Tests: pytest tests/

## Current phase
Phase 1 — not started. Update this line at the end of every session.
